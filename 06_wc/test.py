...
# --------------------------------------------------
def test_only_lines():
    """Only print lines with just -l flag"""
...
def test_only_words():
    """Only print lines with just -w flag"""
...
def test_only_characters():
    """Only print lines with just -c flag"""
...
def test_only_words_characters():
    """Only print lines with just -w and -c flags"""
